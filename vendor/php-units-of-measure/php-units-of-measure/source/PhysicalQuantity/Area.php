...
class Area extends AbstractPhysicalQuantity
{
    ...
    protected static function initialize()
    {
        ...
        // Marla
        //$newUnit = UnitOfMeasure::linearUnitFactory('mrl', 25.2929);
        $newUnit = UnitOfMeasure::linearUnitFactory('mrl', 20.8);
        //$newUnit->addAlias('mrl');
        $newUnit->addAlias('marla');
        static::addUnit($newUnit);

        // kanal
        $newUnit = UnitOfMeasure::linearUnitFactory('knl', 505.857);
        //$newUnit->addAlias('knl');
        $newUnit->addAlias('kanal');
        static::addUnit($newUnit);
    }
}
