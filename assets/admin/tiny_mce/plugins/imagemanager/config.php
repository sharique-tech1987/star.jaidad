<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../eimg/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../eimg/'; // absolute or relative from this script path, required.
