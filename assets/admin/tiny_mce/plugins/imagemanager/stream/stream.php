...
if ($man->isAuthenticated()) {
	...
	die('{"result":{login_url:"' . add_slashes($config["authenticator.login_page"]) . '"},"id":null,"error":{"errstr":"Access denied by authenicator.","errfile":"","errline":null,"errcontext":"","level":"AUTH"}}');
}
?>