...
class M_property_types extends CI_Model
{
    var $table = 'property_types';
    var $id_field = 'id';
...
FROM {$this->table}
        -- LEFT JOIN property_types ON(property_types.id = property_types.parent_id)
WHERE 1 {$where}";
...
/* End of file M_property_types.php */
/* Location: ./application/models/M_property_types.php */