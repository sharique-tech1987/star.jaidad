...
class M_short_news extends CI_Model
{
    var $table = 'short_news';
    var $id_field = 'id';
    ...
    function validate()
    {
        $this->form_validation->set_rules('news', __('News'), 'required');
...
/* End of file M_short_news.php */
/* Location: ./application/models/M_short_news.php */