...
class M_amenities_groups extends CI_Model
{
    var $table = 'amenities_groups';
    var $id_field = 'id';
...
/* End of file M_amenities_groups.php */
/* Location: ./application/models/M_amenities_groups.php */