...
class M_booking extends CI_Model
{
    ...
    function validate()
    {
        $this->form_validation->set_rules('property_id', __('Property'), 'required');
        $this->form_validation->set_rules('member_id', __('Member'), 'required');
...
FROM {$this->table}
        -- LEFT JOIN projects ON(projects.id = booking.property_id)
-- LEFT JOIN users ON(users.id = booking.member_id)
