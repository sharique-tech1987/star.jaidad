...
class M_clients_logo extends CI_Model
{
    var $table = 'clients_logo';
    var $id_field = 'id';
    ...
    function validate()
    {
        $this->form_validation->set_rules('client_name', __('Client Name'), 'required');
...
/* End of file M_clients_logo.php */
/* Location: ./application/models/M_clients_logo.php */