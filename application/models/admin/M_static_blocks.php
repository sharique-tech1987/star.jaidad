...
class M_static_blocks extends CI_Model
{
    ...
    function validate()
    {
        ...
        $this->form_validation->set_rules('identifier', 'Identifier', 'required|db_unique[static_blocks.identifier.id.' . getVar($this->id_field) . ']');
...
/* End of file M_static_blocks.php */
/* Location: ./application/models/m_static_blocks.php */