...
/**
 * Class static_blocks * @property M_Modules $m_modules
...
class Static_blocks extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method m_static_blocks __construct
     * @model M_static_blocks | m_static_blocks
     * *****************************************************************************************************************
     */
    function __construct()
    {
        ...
        //TODO:: Check Login & Module -> static_blocks
    ...
    public function index()
    {
        ...
        $query = "SELECT
            ...
            , status
            , created
        FROM {$this->table} AS static_blocks
        WHERE 1 {$where}";
    ...
    /**
     * *****************************************************************************************************************
     * @method static_blocks ajax_grid | AJAX Grid | AJAX listing
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method static_blocks add | Insert
     * *****************************************************************************************************************
     */
    public function add()
    {
