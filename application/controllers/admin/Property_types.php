...
/**
 * Class property_types * @property M_Modules $m_modules
 * @property M_cpanel $m_cpanel
 * @property M_property_types $module
 * @property M_property_types $m_property_types */
class Property_types extends CI_Controller
{
    ...
    public function index()
    {
        ...
        /** -------- Query */
        $where = $this->where;
        $query = "SELECT property_types.`id`
  , _property_types.type AS `parent`
  , property_types.`type`
  , property_types.`ordering`
  , property_types.`status`
FROM {$this->table} AS property_types
LEFT JOIN property_types AS _property_types ON(_property_types.id = property_types.parent_id)
WHERE 1 {$where}";
...
/* Location: ./application/controllers/admin/property_types.php */