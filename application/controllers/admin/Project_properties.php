...
/**
 * Class project_properties * @property M_Modules $m_modules
 * @property M_cpanel $m_cpanel
 * @property M_project_properties $module
 * @property M_project_properties $m_project_properties */
class Project_properties extends CI_Controller
{
    var $table;
    var $id_field;
    var $module;
    ...
    /**
     * *****************************************************************************************************************
     * @method m_project_properties __construct
     * @model M_project_properties | m_project_properties 
     * *****************************************************************************************************************
     */
    function __construct()
    {
        ...
        //TODO:: Check Login & Module -> project_properties
    ...
    public function index()
    {
        ...
        /** -------- Query */
        $where = $this->where;
        $query = "SELECT project_properties.id
-- , project_properties.project_id
, projects.title AS project
, project_properties.title
, property_types.type
, CONCAT(project_properties.area, ' - ', project_properties.area_unit) AS area 
-- , area.area
, project_properties.price
-- , project_properties.payment_plan
, project_properties.status

FROM {$this->table} AS project_properties
...
-- LEFT JOIN area ON(area.id = project_properties.area)
WHERE 1 {$where}";
    ...
    /**
     * *****************************************************************************************************************
     * @method project_properties ajax_grid | AJAX Grid | AJAX listing
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method project_properties add | Insert
     * *****************************************************************************************************************
     */
    public function add()
    {
    ...
    /**
     * *****************************************************************************************************************
     * @method project_properties update
     * *****************************************************************************************************************
     */
    ...
    public function delete()
    {
        ...
        $delete_files = [
                                    'payment_plan' => asset_dir("front/{$this->table}/"),
                        ];
    ...
    public function view()
    {
        ...
        $config['image_fields'] = [
            'payment_plan' => ['path' => asset_url("front/{$this->table}/"),  'size' => '128x128'],
            ];
...
/* End of file project_properties.php */
/* Location: ./application/controllers/admin/project_properties.php */