...
/**
 * Class galleries * @property M_Modules $m_modules
 * @property M_cpanel $m_cpanel
 * @property M_galleries $module
...
class Galleries extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method m_galleries __construct
     * @model M_galleries | m_galleries
     * *****************************************************************************************************************
     */
    function __construct()
    {
        ...
        //TODO:: Check Login & Module -> galleries
    ...
    /**
     * *****************************************************************************************************************
     * @method galleries index | Grid | listing
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method galleries ajax_grid | AJAX Grid | AJAX listing
     * *****************************************************************************************************************
     */
    ...
    public function delete()
    {
        ...
        $delete_files = [
            'cover_image' => asset_dir("front/{$this->table}/"),
        ];
    ...
    public function file_upload()
    {
        ...
        if (!empty($_FILES)) {
            ...
            if ($this->upload->do_upload('file')) {
                ...
                $thumb_file = _img(base_url(file_icon($dir . $fileinfo['file_name'], true)), 120, 120);
