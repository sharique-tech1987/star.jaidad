...
/**
 * Class pages * @property M_Modules $m_modules
 * @property M_cpanel $m_cpanel
 * @property M_pages $m_pages
 * @property M_pages $module
 */
class Pages extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method m_pages __construct
     * @model M_pages | m_pages 
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method pages ajax_grid | AJAX Grid | AJAX listing
     * *****************************************************************************************************************
     */
    ...
    public function images_upload()
    {
        ...
        if (!empty($_FILES)) {
            ...
            $dir = 'assets/front/pages/';
            if (!is_dir($dir)) mkdir($dir);
            $id = intval(getVar('id'));
            /*if ($id > 0) { $dir .= $id . '/'; mkdir($dir); }*/

            $config['upload_path'] = './' . $dir;
            $config['allowed_types'] = 'jpg|jpeg|gif|png|bmp|pdf|docx|doc|xlsx|xls';
