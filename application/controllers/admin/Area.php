...
/**
 * Class area * @property M_Modules $m_modules
 * @property M_cpanel $m_cpanel
 * @property M_area $module
...
class Area extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method area index | Grid | listing
     * *****************************************************************************************************************
     */
...
, cities.city
, parent.area AS parent_area
, area.area
, area.status
, area.created
FROM `area`
LEFT JOIN area AS parent ON(parent.id = area.parent_id) 
LEFT JOIN cities ON(cities.id = area.city_id) 
-- LEFT JOIN users ON(users.id = area.created_by) 
WHERE 1 {$where}";
        $query .= getFindQuery($query, 'search', ['area' => 'area.area']);
    ...
    /**
     * *****************************************************************************************************************
     * @method area ajax_grid | AJAX Grid | AJAX listing
     * *****************************************************************************************************************
     */
