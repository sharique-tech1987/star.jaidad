...
/**
 * Class projects * @property M_Modules $m_modules
 * @property M_cpanel $m_cpanel
 * @property M_projects $module
...
class Projects extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method m_projects __construct
     * @model M_projects | m_projects
     * *****************************************************************************************************************
     */
    function __construct()
    {
        ...
        //TODO:: Check Login & Module -> projects
...
, cities.city
-- , area.area_id
, CONCAT(projects.price_from, ' - ', projects.price_to) AS price
...
WHERE 1 {$where}";
    ...
    /**
     * *****************************************************************************************************************
     * @method projects ajax_grid | AJAX Grid | AJAX listing
     * *****************************************************************************************************************
     */
    ...
    public function file_upload()
    {
        ...
        if (!empty($_FILES)) {
            ...
            $dir = 'assets/front/projects/';
            if (!is_dir($dir)) mkdir($dir);
            $id = intval(getVar('id'));
            /*if ($id > 0) { $dir .= $id . '/'; mkdir($dir); }*/

            $config['upload_path'] = './' . $dir;
            $config['allowed_types'] = 'jpg|jpeg|gif|png|bmp|gif';
