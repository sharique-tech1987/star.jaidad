...
/**
 * Class amenities_groups * @property M_Modules $m_modules
 * @property M_cpanel $m_cpanel
 * @property M_amenities_groups $module
 * @property M_amenities_groups $m_amenities_groups */
class Amenities_groups extends CI_Controller
{
    var $table;
    var $id_field;
    var $module;
    ...
    /**
     * *****************************************************************************************************************
     * @method m_amenities_groups __construct
     * @model M_amenities_groups | m_amenities_groups 
     * *****************************************************************************************************************
     */
    function __construct()
    {
        ...
        //TODO:: Check Login & Module -> amenities_groups
    ...
    public function index()
    {
        ...
        $where = $this->where;
        $query = "SELECT *
FROM {$this->table} AS amenities_groups
WHERE 1 {$where}";
    ...
    /**
     * *****************************************************************************************************************
     * @method amenities_groups ajax_grid | AJAX Grid | AJAX listing
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method amenities_groups add | Insert
     * *****************************************************************************************************************
     */
    public function add()
    {
    ...
    /**
     * *****************************************************************************************************************
     * @method amenities_groups update
     * *****************************************************************************************************************
     */
...
/* End of file amenities_groups.php */
/* Location: ./application/controllers/admin/amenities_groups.php */