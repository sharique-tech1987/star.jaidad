...
/**
 * Class clients_logo * @property M_Modules $m_modules
 * @property M_cpanel $m_cpanel
 * @property M_clients_logo $module
 * @property M_clients_logo $m_clients_logo */
class Clients_logo extends CI_Controller
{
    var $table;
    var $id_field;
    var $module;
    ...
    /**
     * *****************************************************************************************************************
     * @method m_clients_logo __construct
     * @model M_clients_logo | m_clients_logo 
     * *****************************************************************************************************************
     */
    function __construct()
    {
        ...
        //TODO:: Check Login & Module -> clients_logo
    ...
    /**
     * *****************************************************************************************************************
     * @method clients_logo index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        $where = $this->where;
        $query = "SELECT *
FROM {$this->table} AS clients_logo
WHERE 1 {$where}";
    ...
    /**
     * *****************************************************************************************************************
     * @method clients_logo ajax_grid | AJAX Grid | AJAX listing
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method clients_logo add | Insert
     * *****************************************************************************************************************
     */
    public function add()
    {
    ...
    public function delete()
    {
        ...
        $delete_files = [
                                    'logo' => asset_dir("front/{$this->table}/"),
                        ];
    ...
    /**
     * *****************************************************************************************************************
     * @method clients_logo view | Record
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method clients_logo AJAX actions
     * *****************************************************************************************************************
     */
...
/* End of file clients_logo.php */
/* Location: ./application/controllers/admin/clients_logo.php */