...
/**
 * Class area_reviews * @property M_Modules $m_modules
 * @property M_cpanel $m_cpanel
 * @property M_area_reviews $module
 * @property M_area_reviews $m_area_reviews */
class Area_reviews extends CI_Controller
{
    var $table;
    var $id_field;
    var $module;
    ...
    /**
     * *****************************************************************************************************************
     * @method m_area_reviews __construct
     * @model M_area_reviews | m_area_reviews 
     * *****************************************************************************************************************
     */
    function __construct()
    {
        ...
        //TODO:: Check Login & Module -> area_reviews
    ...
    /**
     * *****************************************************************************************************************
     * @method area_reviews index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Query */
        $where = $this->where;
        $query = "SELECT area_reviews.id
-- , area_reviews.area_id
, area.area
-- , area_reviews.user_id
, IF(area_reviews.user_id > 0, CONCAT_WS(' ', users.first_name, last_name), area_reviews.name) AS member
, area_reviews.comment
, area_reviews.created
, area_reviews.status
, area_reviews.score

FROM area_reviews
LEFT JOIN area ON(area.id = area_reviews.area_id)
LEFT JOIN users ON(users.id = area_reviews.user_id) 
-- LEFT JOIN users ON(users.id = area_reviews.user_id)
WHERE 1 {$where}";
    ...
    /**
     * *****************************************************************************************************************
     * @method area_reviews ajax_grid | AJAX Grid | AJAX listing
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method area_reviews add | Insert
     * *****************************************************************************************************************
     */
    public function add()
    {
    ...
    /**
     * *****************************************************************************************************************
     * @method area_reviews view | Record
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method area_reviews AJAX actions
     * *****************************************************************************************************************
     */
...
/* End of file area_reviews.php */
/* Location: ./application/controllers/admin/area_reviews.php */