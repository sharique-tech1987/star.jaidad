...
/**
 * Class income * @property M_Modules $m_modules
 * @property M_cpanel $m_cpanel
 * @property M_income $module
...
class Income extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method m_income __construct
     * @model M_income | m_income
     * *****************************************************************************************************************
     */
    function __construct()
    {
        ...
        //TODO:: Check Login & Module -> income
    ...
    public function index()
    {
        ...
        /** -------- Query */
        $where = $this->where;
        $query = "SELECT income.id
, income.title
, TRIM(CONCAT(IFNULL(incom_user.first_name, ''), ' ', IFNULL(incom_user.last_name, ''))) as income_by
, income.booking_id
, income.date
, income.amount
, income.created
...
, income.cheque_status

FROM {$this->table} AS income
LEFT JOIN users ON(users.id = income.created_by) 
LEFT JOIN users AS incom_user ON(incom_user.id = income.income_by) 
WHERE 1 {$where}";
    ...
    /**
     * *****************************************************************************************************************
     * @method income ajax_grid | AJAX Grid | AJAX listing
     * *****************************************************************************************************************
     */
