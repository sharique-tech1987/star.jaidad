...
/**
 * Class amenities * @property M_Modules $m_modules
 * @property M_cpanel $m_cpanel
 * @property M_amenities $module
...
class Amenities extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method m_amenities __construct
     * @model M_amenities | m_amenities
     * *****************************************************************************************************************
     */
    function __construct()
    {
        ...
        //TODO:: Check Login & Module -> amenities
    ...
    public function index()
    {
        ...
        $query = "SELECT amenities.id
                    ...
                    ,  amenities.ordering
                    ,  amenities.`status`
                    , amenities_groups.title AS `group`
                FROM {$this->table} AS amenities
    ...
    /**
     * *****************************************************************************************************************
     * @method amenities ajax_grid | AJAX Grid | AJAX listing
     * *****************************************************************************************************************
     */
    ...
    public function view()
    {
        ...
        $config['image_fields'] = ['icon' => ['path' => asset_url("front/{$this->table}/"),  'size' => '128x128']];
