...
/**
 * Class developer_log * @property M_Modules $m_modules
 * @property M_cpanel $m_cpanel
 * @property M_developer_log $module
 * @property M_developer_log $m_developer_log
 */
class Developer_log extends CI_Controller
{
    var $table;
    var $id_field;
    var $module;
    ...
    /**
     * *****************************************************************************************************************
     * @method m_developer_log __construct
     * @model M_developer_log | m_developer_log
     * *****************************************************************************************************************
     */
    function __construct()
    {
        ...
        //TODO:: Check Login & Module -> developer_log
    ...
    /**
     * *****************************************************************************************************************
     * @method developer_log index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        $query = "SELECT id
            ...
            , current_URL
            , status
            FROM {$this->table} AS developer_log
            WHERE 1 {$where}";
    ...
    /**
     * *****************************************************************************************************************
     * @method developer_log ajax_grid | AJAX Grid | AJAX listing
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method developer_log add | Insert
     * *****************************************************************************************************************
     */
    public function add()
    {
    ...
    /**
     * *****************************************************************************************************************
     * @method developer_log view | Record
     * *****************************************************************************************************************
     */
    public function view()
    {
        ...
        $config['buttons'] = ['new', 'edit', 'delete', 'refresh', 'print', 'back', 'status'];
        $config['hidden_fields'] = ['created_by'];
        $config['image_fields'] = [];
        $config['status_column_data'] = get_enum_values($this->table, 'status');
        $config['custom_func'] = ['status' => 'status_options'];
        $config['attributes'] = [
            'id' => ['title' => 'ID'],
        ];
        $data['config'] = $config;
    ...
    /**
     * *****************************************************************************************************************
     * @method developer_log AJAX actions
     * *****************************************************************************************************************
     */
...
/* End of file developer_log.php */
/* Location: ./application/controllers/admin/developer_log.php */