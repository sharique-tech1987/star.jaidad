            ...
            <div class="entry-content">
                <?php if ($page->show_title) { ?>
                    <div class="section mcb-section bg-cover"
                         style="padding-top:200px; padding-bottom:125px; background-image:url('<?php echo asset_url('front/pages/' . $page->thumbnail); ?>'); background-repeat:no-repeat; background-position:right top">
