<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="post"
      ...
      id="static_blocks" action="<?php echo admin_url($this->_route . (!$row->id ? '/add' : '/update/' . $row->id)); ?>">
    <?php
    ...
    <input type="hidden" name="id" class="form-control" placeholder="ID" value="<?php echo $row->id; ?>">
        <div class="m-portlet__body">
            ...
            <div class="form-group m-form__group row">
                <label class="col-sm-2 control-label required"><?php echo __('Identifier');?></label>
                <div class="col-lg-6">
                    <input type="text" name="identifier" id="identifier" class="form-control" placeholder="Identifier" value="<?php echo ($row->identifier);?>"/>
                </div>
            </div>
            <div class="form-group m-form__group row">
                <label class="col-sm-12 control-label text-center"><?php echo __('Content');?></label>
                <div class="col-lg-12">
                    <textarea name="content" id="content" placeholder="Content" class="editor form-control" cols="30" rows="20"><?php echo $row->content;?></textarea>
                </div>
            </div>
        </div>
...
<script>
    ...
    $( "form#static_blocks" ).validate({
        ...
        messages: {
            ...
            'identifier': {required: 'Identifier is required', remote: 'This Identifier is already exist',},
        },
