...
?>
<!--begin::Form-->
<form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="post" enctype="multipart/form-data" id="blog_categories" action="<?php echo admin_url($this->_route . (!$row->id ? '/add' : '/update/' . $row->id)); ?>">
    <?php
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-6">
                <select name="parent_id" id="parent_id" class="form-control m-select2">
                    ...
                    $this->multilevels->query = "SELECT id,`type`,parent_id FROM blog_categories WHERE 1 ORDER BY id DESC";
