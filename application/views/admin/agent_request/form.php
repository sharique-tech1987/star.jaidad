    ...
    <div class="m-portlet__body">
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-3">
                ...
                <select name="city" id="city" class="form-control m-select2" load-select="#areas">
                    <option value="">- Select -</option>
                    <?php echo selectBox("SELECT id, city FROM cities", $row->city)?>
                </select>
            </div>
            <div class="col-lg-3">
                <label class="control-label"><?php echo __('Area');?></label><br>
                <!--<select name="areas[]" id="areas" class="form-control m_select2-tags" multiple>-->
                <select name="area_id" id="area_id" class="form-control m-select2" load-url="<?php echo site_url('property/ajax/city_area');?>">
                    <option value="">- Select -</option>
                    <?php echo selectBox("SELECT id, area FROM area WHERE city_id='{$row->city}'", $row->area_id)?>
                </select>
            </div>
        </div>
        <div class="form-group m-form__group row">
