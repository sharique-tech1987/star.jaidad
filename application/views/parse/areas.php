...
<div class="container">
    <form method="get" action="<?php echo site_url('parse/fetch_areas');?>" class="form-signin" enctype="multipart/form-data">
...
/*                $OP = ['URL', 'Location'];
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <a href="<?php echo site_url('parse/property');?>" class="btn btn-warning btn-block">Fetch Properties</a>
            </div>
        </div>
    </form>
    <script>
